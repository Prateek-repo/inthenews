  ...
  render() {
    ...
    return (
      <div style={{ backgroundColor: darkModeStatus ? "black" : null }}>
        <Router>
          <NavBar
            setTheCountry={this.setCountry}
            category={category}
            darkMode={this.darkModeEnable}
          />
          <LoadingBar
            color="#f11946"
            progress={progress}
          ...
          <Routes>
            ...
            <Route
              exact
              path="/general"
              element={this.routeElement("general", "general")}
            />
            <Route
              exact
              path="/health"
              element={this.routeElement("health", "health")}
            />
            <Route
              exact
              path="/business"
              element={this.routeElement("business", "business")}
            />
            <Route
              exact
              path="/entertainment"
              element={this.routeElement("entertainment", "entertainment")}
            />
            <Route
              exact
              path="/sports"
              element={this.routeElement("sports", "sports")}
            />
            <Route
              exact
              path="/technology"
              element={this.routeElement("technology", "technology")}
            />
            <Route
              exact
              path="/science"
              element={this.routeElement("science", "science")}
            />
          </Routes>
        </Router>
      </div>
